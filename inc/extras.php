 ...
 * @return array
 */
function kuorinka_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'kuorinka_page_menu_args' );
 ...
 * @return array
 */
function kuorinka_body_classes( $classes ) {
 ...
 * @return void
 */
function kuorinka_setup_author() {
	global $wp_query;
...
add_action( 'wp', 'kuorinka_setup_author' );
