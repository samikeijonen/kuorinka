 ...
 * @return string
 */
function kuorinka_archive_title_filter( $title ) {
	...
	elseif ( is_search() ) {
		$title = sprintf( esc_html__( 'Search results for &#8220;%s&#8221;', 'kuorinka' ), get_search_query() );
	}
	...
	return apply_filters( 'kuorinka_archive_title', $title );
}
add_filter( 'get_the_archive_title', 'kuorinka_archive_title_filter', 5 );
 ...
 * @return string
 */
function kuorinka_archive_description_filter( $desc ) {
	...
	return apply_filters( 'kuorinka_archive_description', $desc );
}
add_filter( 'get_the_archive_description', 'kuorinka_archive_description_filter', 5 );