<?php if ( '1c' != get_theme_mod( 'theme_layout' ) ) : // If the layout is not one column. ?>
	...
	<aside id="sidebar-primary" class="sidebar" role="complementary" aria-label="<?php echo esc_attr_x( 'Primary Sidebar', 'Sidebar aria label', 'kuorinka' ); ?>" <?php hybrid_attr( 'sidebar', 'primary' ); ?>>
